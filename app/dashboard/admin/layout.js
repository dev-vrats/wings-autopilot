...
import { LayoutDashboard, Users, Building2, MessageSquare, Settings, LogOut } from "lucide-react";
import { useAuth } from "@/context/AuthContext";
import { auth } from "@/lib/firebase";

const navItems = [
  { name: "Overview", href: "/dashboard/admin", icon: LayoutDashboard },
  { name: "Service Providers", href: "/dashboard/admin/providers", icon: Users },
  { name: "Local Businesses", href: "/dashboard/admin/businesses", icon: Building2 },
  { name: "Content Requests", href: "/dashboard/admin/requests", icon: MessageSquare },
    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <aside className="w-64 border-r border-divider bg-background flex flex-col hidden md:flex">
        <div className="p-6 border-b border-divider">
          ...
          <p className="text-xs text-muted mt-1 uppercase tracking-wider font-semibold">Admin Panel</p>
        </div>
